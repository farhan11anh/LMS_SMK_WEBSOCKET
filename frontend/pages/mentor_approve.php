...
<body>
    ...
    <div class="flex items-center">
        ...
        <div class="bg-cgray w-full h-screen px-10 py-6 flex flex-col gap-y-6 overflow-y-scroll rightbar">
            ...
            <div class="bg-white w-125% md:w-full h-[50px] px-10 rounded-xl">
                <ul class="flex items-center gap-x-4 md:gap-x-8">
                    ...
                    <a href="http://localhost/websocket/web-chat-room/frontend/pages/mentor.php">
                        <li
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-b px-4 py-2 text-center">
                                ...
                                <button type="button"
                                    class="px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 mb-2 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    onclick="changeStatus(<?= $acceptance['acceptance_id'] ?>, 'approve')">Approve</button>
                                <button type="button"
                                    class="text-red-700 ml-1 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center mr-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900 "
                                    onclick="changeStatus(<?= $acceptance['acceptance_id'] ?>, 'reject')">Not
                                    Approve</button>
                                <?php } elseif ($acceptance['status'] == 'active') { ?>
                                <button disabled type="button"
                                    class="px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 mb-2 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                    onclick="changeStatus(<?= $acceptance['acceptance_id'] ?>)">Approved</button>
                                <?php } else { ?>
                                <button disabled type="button"
                            ...
                            <td class="border-b px-4 py-2 text-center">
                                ...
                                <a href="http://localhost/websocket/web-chat-room/group_chat.php"><button type="button"
                                        class="px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Konsultasi</button></a>
                                <?php } else { ?>
                                <p>Reject</p>
                                <?php } ?>
                            </td>
