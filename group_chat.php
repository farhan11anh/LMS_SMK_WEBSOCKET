                        ...
                        <div class="w-2/3 border rounded-lg border-gray-300 bg-white">
                            <div>
                                <div class="flex gap-x-4 py-3 px-7">
                                    ...
                                    <div class="">
                                        <p class="flex py-4 text-dark-green text-base font-bold" id="title-cons">
                                            Bimbingan
                                        </p>
                                        ...
                                        <div>
                                            <div class="flex gap-x-4 py-3 px-7">
                                                <!-- <img class="w-14" src="Img/icons/default_profile.svg" alt="Profile Image"> -->
                                                <div class="">
                                                    <p class="flex py-4 text-dark-green font-bold text-lg"> BIMBINGAN
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <li>
                                                            ...
                                                            <a onclick="requestChat(<?= $group['group_id'] ?> , '<?= $email ?>', '<?= $group['group_name'] ?>' )"
                                                                ...
                                                                <img class="object-cover w-11 h-12 rounded-full"
                                                                    src="Img/icons/default_profile.svg"
                                                                    alt="Profile Image">
                                    ...
                                    success: function(data, status) {
                                        ...
                                        for (let e in message) {
                                            ...
                                            let contain = '<div class="max-w-fit ' + styleBox +
                                                ' rounded-xl px-4 py-2 ..."><small class="font-semibold">' +
                                                val['name'] +
                                                '</small><p class="">' + val['message'] +
                                                '</p><p class="text-right text-xs text-gray-400 ">' + val[
                                                    'created_at'] +
                                                '</p></div>';
                            ...
                            new EmojiPicker({
                                trigger: [{
                                        selector: ".first-btn",
                                        insertInto: [".one",
                                        ".two"], // '.selector' can be used without array
                                    },
                                    {
                                        selector: ".second-btn",
                                        insertInto: ".two",
