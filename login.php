...
<body>
    <div
        class="w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12 xl:w-4/12 max-h-max mx-auto shadow-lg shadow-gray-200 rounded-lg border p-10 mt-10">
        ...
        <form class="mt-8 flex flex-col gap-y-4" action="" method="POST">
            <div class="flex flex-col">
                ...
                <input class="h-10 pl-2 outline-none border border-gray-200 rounded-lg focus:border-blue-500"
            ...
            <button class="bg-blue-500 hover:bg-blue-600 w-full py-2 rounded-lg text-white font-semibold" type="submit"
